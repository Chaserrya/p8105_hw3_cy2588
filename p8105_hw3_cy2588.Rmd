...
accel_df %>% 
  ...
  scale_x_continuous(name ="minute" ,
   ...
   scale_y_continuous(name = "activity count", 
                      trans = "sqrt")
```
Based on this graph, it's seems that daily active time of this 63 year-old male is basically from 8am to 10pm, and for some week, Saturday and Sunday
...
### 3
* tmax vs tmin for the full dataset hexplot
```{r}
ny_noaa_df %>%
...
* the distribution of snowfall values greater than 0 and less than 100 separately by year  box or violin
```{r}
ny_noaa_df %>%
